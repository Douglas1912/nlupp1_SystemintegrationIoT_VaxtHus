...
public class MeasuresDao {
    public List<Measures> getAllMeasures(){
        ...
        Measures m2 = new Measures(2, 1, "sensorVäxtHuset", 5.1f, 40.5f, 72, "02-05-2020 18:30:15");
        Measures m3 = new Measures(3, 1, "sensorVäxtHuset", 4.0f, 50.2f, 75, "03-05-2020 17:05:21");
        Measures m4 = new Measures(4, 1, "sensorVäxtHuset", 10.6f, 55.8f, 85, "04-05-2020 17:10:11");
        Measures m5 = new Measures(5, 1, "sensorVäxtHuset", 15.5f, 75.2f, 90, "05-05-2020 18:34:54");
